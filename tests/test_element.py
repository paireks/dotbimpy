from dotbimpy import Color, Element, Rotation, Vector
...
def test_init():
    ...
    assert element.rotation == Rotation(
        0.6397929577145492, 0.1062698214791025, -0.1247209304773680, -0.750877077691500
    )
    assert element.vector == Vector(5, 3, 2)
    assert element.color == Color(31, 30, 50, 4)
    assert element.guid == UUID("8f6bc6d0-4f24-4bd0-917a-82ab1c22a5bb")
    ...
    [
        ...
        (
            Element(
                ...
                type="Beam",
                info={"Name": "Pyramid", "Another name": "Another Pyramid"},
            ),
            False,
        ),
        (
